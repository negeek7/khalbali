...
//   render() {
//     const { username, password, confirmPassword, doNotMatchError, checkBox } =
//       this.state;
...
//           <div>
//             <h1 className={loginStyle.heading}>Welcome to Forum 19</h1>
...
//                 </Button>
//               </div>
//               <p style={{ color: '#666f74' }}>
//                 Don’t have an account?
//                 <Link to="#" className={loginStyle.term}>
//                   Signup Here
//                 </Link>
//               </p>
//               <h5 className={loginStyle.h5}>
